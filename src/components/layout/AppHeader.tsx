        ...
        <div className="flex items-center gap-2.5">
          ...
          <nav className="flex items-center gap-1">
            ...
            {headerSubtitle && (
              <>
                <ChevronRight size={11} className={darkMode ? 'text-[#333333]' : 'text-gray-300'} />
                <span className={`text-[11px] font-semibold font-['Montserrat'] ${darkMode ? 'text-[#D7B797]' : 'text-[#6B4D30]'}`}>
                  {headerSubtitle}
                </span>
              </>
            )}
                      ...
                      >
                        <div className={`p-1.5 rounded-lg ${
                          ...
                          {isCompleted ? (
                            ...
                            <Icon size={14} className={isCurrent ? 'text-[#0A0A0A]' : darkMode ? 'text-[#666666]' : 'text-gray-500'} strokeWidth={2} />
                          )}
                        </div>
                      </button>
                    ) : (
