const en = {
  ...
  ticket: {
    ...
    tryAdjustingSearch: 'Try adjusting your search criteria to find what you are looking for.',
    createFirstTicket: 'Create your first ticket to get started with the approval process.',
