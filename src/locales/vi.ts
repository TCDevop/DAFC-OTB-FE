const vi = {
  ...
  ticket: {
    ...
    noMatchingTickets: 'Không tìm thấy phiếu phù hợp',
    tryAdjustingSearch: 'Thử điều chỉnh tiêu chí tìm kiếm để tìm kết quả phù hợp.',
    createFirstTicket: 'Tạo phiếu đầu tiên để bắt đầu quy trình phê duyệt.',
  ...
  approvals: {
    ...
    colType: 'Loại',
    colName: 'Tên',
    colGroupBrand: 'Nhóm thương hiệu',
    colBrand: 'Thương hiệu',
    colLevel: 'Cấp',
    allGroupBrands: 'Tất cả nhóm TH',
    allBrands: 'Tất cả thương hiệu',
